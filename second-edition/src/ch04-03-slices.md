...
Мы будем изучать итераторы более детально в главе 13. Сейчас, достаточно понять,
...
будет срезом, которая содержит ссылку на 7ой байт в `s` и длину равной `5`. 

Рисунок 4-12 объяснет это схематично.
